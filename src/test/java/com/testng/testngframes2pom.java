...
public class testngframes2pom extends Framespage2 {
	@Test(priority = -1)
	public void ValidatingSingleFrame() {
		System.out.println("inside ValidatingSingleFrame");
		LibraryFunctions.driver.navigate().to(LibraryFunctions.ObjProperties.getProperty("Frames1URL"));
		...
		Assert.assertEquals(titleofFrames, LibraryFunctions.ObjProperties.getProperty("Title1OfFrames"));
