...
public class practicefileupload extends Fileupload {
	@Test(priority = -1)
	public void LoadingFileUploadPage() {
		...
		driver.navigate().to(ObjProperties.getProperty("fileupload"
				+ ""
				+ "C:\\Users\\ngurram\\eclipse-workspace\\seleniummypractice\\src\\test\\resources\\materials\\fileupload.txt")); //to direct to the website navigate is used
