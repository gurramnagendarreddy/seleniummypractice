...
public class TestngFramespom extends  LibraryFunctions{
  @Test(priority= -1)
  public void SingleFrame() {
      ...
      LibraryFunctions.driver.switchTo().frame("frame2");
  ...
  public void validatingIframeWithInIframe() {
      ...
      LibraryFunctions.driver.switchTo().frame("frame1");
      ...
      LibraryFunctions.driver.switchTo().frame("frame3");
